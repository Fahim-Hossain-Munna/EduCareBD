...
<body>
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <div class="logo">
                <a href="index.html">EduCare BD</a>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input name='name' type="text" class="form-control m-b-md @error('name') is-invalid @enderror" id="signUpUsername" aria-describedby="signUpUsername" placeholder="Enter Name">
                    @error('name')
                    ...
                    <input name='email' type="email" class="form-control m-b-md @error('email') is-invalid @enderror" id="signUpEmail" aria-describedby="signUpEmail" placeholder="example@neptune.com">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    ...
                    <input name='password' type="password" class="form-control m-b-md @error('password') is-invalid @enderror" id="signUpPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    ...
                    <input name='password_confirmation' type="password" class="form-control @error('password_confirmation') is-invalid @enderror" id="signUpPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
